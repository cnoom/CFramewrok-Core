...
namespace CFramework.Core
{
    public class CFramework
    {
            ...
            LoggerBootstrapOptions loggerOptions = null)
        {
            ...
            LoggerBootstrapOptions effectiveLoggerOptions = loggerOptions ?? new LoggerBootstrapOptions();
            ...
            CFExecutionOptions exec = executionOptions ?? new CFExecutionOptions();
            BroadcastManager =
        ...
        {
            ModuleManager.PhysicsUpdate();
        }
        public void OnApplicationPause(bool isPaused)
        {
            ModuleManager.OnApplicationPause(isPaused);
        }
