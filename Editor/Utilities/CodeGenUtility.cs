...
namespace CFramework.Core.Editor.Utilities
{
    public static class CodeGenUtility
    {
        public static readonly HashSet<string> CSharpKeywords = new HashSet<string>(new[]
        {
            ...
            "while", "add", "alias", "ascending", "async", "await", "by", "descending", "dynamic", "equals", "from",
            "get", "global", "group", "into", "join", "let", "nameof", "not", "notnull", "on", "or", "orderby",
            "partial", "remove", "select", "set", "unmanaged", "value", "var", "when", "where", "with", "yield"
        ...
        {
            var id = ToIdentifier(name, emptyFallback);
